...
assert.equal(slides.length, 13, 'deck must contain exactly thirteen registered slides');
assert.deepEqual(
  slides.map((match) => match[1]),
  ['S01', 'S22', 'S17', 'S13', 'S22', 'S08', 'S09', 'S05', 'S17', 'S14', 'S11', 'S13', 'S10'],
...
console.log('PASS botanical Swiss deck structure (13 slides)');
